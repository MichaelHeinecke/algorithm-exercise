from algorithm_exercise.product_of_array_items import multiply_array_items_without_self, \
...
def test_array_items_are_multiplied_correctly_1():
    ...
    assert multiply_array_items_without_self(input_array) == expected_output_array
